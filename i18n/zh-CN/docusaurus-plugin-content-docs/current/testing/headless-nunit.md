---
id: headless-nunit
title: 结合 NUnit 的无头测试
description: 了解如何使用 NUnit 测试框架为 Avalonia 应用配置并运行无头 UI 测试。
doc-type: guide
---

## 准备工作

本页假定你已经创建好了 NUnit 项目。
如果还没有，请先参考 NUnit 的 “Getting Started” 与 “Installation” 文档：https://docs.nunit.org/articles/nunit/getting-started/installation.html。

## 安装包

除了 NUnit 本身的包之外，你还需要再安装两个包：
- [Avalonia.Headless.NUnit](https://www.nuget.org/packages/Avalonia.Headless.NUnit)，它也会一并引入 Avalonia。
...
不要使用常规的 `[Test]`，而应使用 `[AvaloniaTest]`，因为它会负责初始化 UI 线程。

## 另请参阅

- [适用于 NUnit 的可测试示例应用](https://github.com/AvaloniaUI/Avalonia.Samples/tree/main/src/Avalonia.Samples/Testing/TestableApp.Headless.NUnit)
- [无头测试平台](/docs/testing/setting-up-the-headless-platform)
- [结合 XUnit 的无头测试](/docs/testing/headless-xunit)
